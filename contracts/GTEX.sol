...
contract GTEX is ERC20Interface, Pausable {
    ...
    function batchLockArray(address[] memory accounts, uint[] memory lockedToken) public whenNotPaused onlyAdmin {
    ...
    //VIP Batch with lock
    function batchVipWithLock(address[] memory receivers, uint[] memory tokens, bool freeze) public whenNotPaused onlyAdmin {
